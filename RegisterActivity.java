...
import com.mtesitoo.backend.service.TermsRequest;
            ...
            public void onClick(View view) {
                ...
                if(verifyInput()){
                  ...
                  AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                    ;
               //     String link = "<a href=\"http://tesitoo.com/index.php?route=information/information&information_id=8">"Terms"</a>
                    String link = "<a href=\"http://www.google.com\">http://www.google.com</a>";
                   // String message = "Some links: "+link+"";
    ...
    public void startNewLogin(Seller seller, final Context mContext) {
        ...
        loginService.authenticateUser(seller.getUsername(), seller.getmPassword(), new ICallback<String>() {
            ...
            public void onResult(String result) {
               ...
               /* ITermsRequest termsRequest = new TermsRequest(RegisterActivity.this);
                termsRequest.getTerms(new ICallback<Terms>() {
                    @Override
                    public void onResult(Terms terms) {
                        Log.d("getSellerInfo", terms.toString());
                 //       logUser(terms);
                        intent.putExtra(mContext.getString(R.string.bundle_seller_key), Terms,
